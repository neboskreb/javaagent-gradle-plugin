...
dependencies {
    ...
    testImplementation("com.android.application:com.android.application.gradle.plugin:9.4.1")
    testImplementation("com.android.library:com.android.library.gradle.plugin:9.4.1")
